	...
	if (isset($_POST['submit']))
	{
        ...
        if (!isset($_FILES['image']['tmp_name'])) {
            ...
            if ($error > 0){
				...
				mySQLi_query($con,"INSERT INTO pets (pet_id,name,birthday,profile_picture_pet,family_id,food_plan,restrictions)
				VALUES ('$count','$pet_name','$pet_birthday','$location','$family_id','$pet_plan','$pet_restrictions')");
