...
?>
    <?php
	include("includes/database.php");
			$query=mySQLi_query($con,"SELECT * from posts LEFT JOIN user on user.user_id = posts.user_id order by created DESC");
			while($row=mySQLi_fetch_array($query)){
...
?>
		 ...
		 <form  method="POST" action="comment.php">			
			...
			<input type="hidden" name="image" value="<?php echo $row['profile_picture']  ?>">
