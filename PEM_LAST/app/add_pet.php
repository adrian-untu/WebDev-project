...
<body>
    ...
    <div class="header">
      ...
      <div id="container">
		<div id="left-nav">
             <form method="post" action="scripts/add_pet_script.php" enctype="multipart/form-data">
		...
		<fieldset class="---------------">
			...
			<table cellpadding="5" cellspacing="5">
				<tr>
					...
					<td><input type="date" name="birthday" class="form-1" title="Enter your username" required /></td>
				</tr>
                <tr>
