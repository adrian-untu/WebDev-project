    ...
    <div class="container">
      <div class="forms-container">
        ...
        <div class="signin-signup">
          <!-- SIGN IN FORM-->
          <form action="scripts/signin.php" method="post" class="sign-in-form" enctype="multipart/form-data">
          ...
          <!-- SIGN UP FORM-->
          <form method="post" action="scripts/signup.php" enctype="multipart/form-data" class="sign-up-form">
